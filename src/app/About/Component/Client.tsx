      ...
      <div className="container mx-auto">
        <div className="bg-[--About-bg] ">
          <div className="mb-5">
            ...
            <h3 className="Montserrat uppercase font-extrabold text-[24px] md:text-[28px] lg:text-[40px] text-center">
          ...
          <SwiperSlide>
            <div className="bg-white p-4 rounded-lg shadow-lg transform ">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  <h3 className="font-bold Montserrat text-[20px]">
                    Fredi Allan
                  </h3>
                  <p className="text-black text-[12px] Montserrat font-normal">
                    Founder, ABC
                  </p>
                  <div>
