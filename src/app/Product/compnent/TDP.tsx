      ...
      <div>
        <div className=" relative w-full h-64 sm:h-56 md:h-64 lg:h-80 bg-cover bg-center overflow-hidden bgImage">
          <div className="lg:container lg:mx-auto">
            <div className="text-white px-4 text-justify py-7 lg:pt-20 md:ml-4 lg:ml-20 md:pt-6 ">
              <h4 className="Montserrat font-extrabold md:text-[26px] lg:text-[48px] uppercase">
                Target Products
              </h4>
              <p className="Montserrat font-normal lg:text-[14px] md:max-w-80">
